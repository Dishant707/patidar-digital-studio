...
export default function Navbar() {
    ...
    return (
        <motion.nav
            ...
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-stone-950/80 backdrop-blur-xl border-b border-white/10' : 'bg-transparent'
                }`}
        >
